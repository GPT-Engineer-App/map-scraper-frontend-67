  ...
  return (
    <Box p="4">
      <VStack spacing={4}>
        ...
        <HStack spacing={4}>
          <Button colorScheme={timePeriod === "week" ? "blue" : "gray"} onClick={() => setTimePeriod("week")}>
            Week
          </Button>
          <Button colorScheme={timePeriod === "month" ? "blue" : "gray"} onClick={() => setTimePeriod("month")}>
            Month
          </Button>
          <Button colorScheme={timePeriod === "year" ? "blue" : "gray"} onClick={() => setTimePeriod("year")}>
            Year
          </Button>
        </HStack>
